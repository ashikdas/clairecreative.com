...
<div class="<?php echo esc_attr( $classname ); ?>">
    <div class="vp-portfolio__item-meta">
        ...
        ?>
        <div class="vp-portfolio__item-meta-group nk-post-meta">
            <?php
            // Show Date.
            if ( $opts['show_date'] ) {
                ?>
            ...
            // Show Comments Count.
            if ( $opts['comments_number'] ) {
                ?>
                <div class="vp-portfolio__item-meta-comments-count">
                    <?php
                    // translators: %s - comments count.
                    echo esc_html( sprintf( _n( '%s comment', '%s comments', $args['comments_count'], 'skylith' ), $args['comments_count'] ) );
                    ?>
                </div>
                <?php
            }
        ...
        if ( $opts['read_more'] ) {
            ...
            <div class="vp-portfolio__item-meta-read-more">
                <a href="<?php echo esc_url( $args['url'] ); ?>"
                    ...
                    ?>
                    class="nk-btn nk-btn-md nk-btn-outline nk-btn-color-gray-7 nk-btn-hover-color-dark-3 text-dark"><?php echo esc_html__( 'Read More', 'skylith' ); ?></a>
            </div>
            <?php
        }
        ?>
