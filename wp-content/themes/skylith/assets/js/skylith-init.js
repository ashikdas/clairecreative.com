...
function (module, exports, __webpack_require__) {
  ...
  var $opts = window.skylithInitOptions;
  var __ = $opts.__;
  /*------------------------------------------------------------------
  ...
  var options = {
    enableShortcuts: $opts.enableShortcuts == 1,
    scrollToAnchorSpeed: parseInt($opts.scrollToAnchorSpeed, 10) || 700,
    parallaxSpeed: 0.8,
    templates: {
      sliderAuthor: __.sliderAuthor,
      navbarBackItem: __.navbarBackItem,
