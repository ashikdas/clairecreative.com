...
class Ghost_Framework_Kirki_Field_Image extends Ghost_Framework_Kirki_Field {
    ...
    protected function set_button_labels() {
        $this->button_labels = wp_parse_args(
            $this->button_labels,
            array(
                'select'       => esc_html__( 'Select image', 'skylith' ),
                'change'       => esc_html__( 'Change image', 'skylith' ),
                'default'      => esc_html__( 'Default', 'skylith' ),
                'remove'       => esc_html__( 'Remove', 'skylith' ),
                'placeholder'  => esc_html__( 'No image selected', 'skylith' ),
                'frame_title'  => esc_html__( 'Select image', 'skylith' ),
                'frame_button' => esc_html__( 'Choose image', 'skylith' ),
            )
        );
    }
