...
class Ghost_Framework_Kirki extends Ghost_Framework_Kirki_Init {
    ...
    public static function add_field( $config_id, $args ) {
        if ( doing_action( 'customize_register' ) ) {
            _doing_it_wrong( __METHOD__, esc_html__( 'Ghost_Framework_Kirki fields should not be added on customize_register. Please add them directly, or on init.', 'skylith' ), '3.0.10' );
        }
