...
data.choices.labels = _.defaults( data.choices.labels, {
    select: '<?php esc_html_e( 'Select image', 'skylith' ); ?>',
    change: '<?php esc_html_e( 'Change image', 'skylith' ); ?>',
    'default': '<?php esc_html_e( 'Default', 'skylith' ); ?>',
    remove: '<?php esc_html_e( 'Remove', 'skylith' ); ?>',
    placeholder: '<?php esc_html_e( 'No image selected', 'skylith' ); ?>',
    frame_title: '<?php esc_html_e( 'Select image', 'skylith' ); ?>',
    frame_button: '<?php esc_html_e( 'Choose image', 'skylith' ); ?>',
} );
#>
