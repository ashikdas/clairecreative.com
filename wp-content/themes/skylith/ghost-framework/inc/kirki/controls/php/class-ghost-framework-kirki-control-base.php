    ...
    public function enqueue() {
        ...
        wp_localize_script(
            ...
            array(
                ...
                'noFileSelected'       => esc_html__( 'No File Selected', 'skylith' ),
                'remove'               => esc_html__( 'Remove', 'skylith' ),
                'default'              => esc_html__( 'Default', 'skylith' ),
                'selectFile'           => esc_html__( 'Select File', 'skylith' ),
                'standardFonts'        => esc_html__( 'Standard Fonts', 'skylith' ),
                'googleFonts'          => esc_html__( 'Google Fonts', 'skylith' ),
                'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'skylith' ),
                'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'skylith' ),
            )
        );
