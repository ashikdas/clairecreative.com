...
class NKTH_Theme_Dashboard {
    ...
    public function admin_print_styles() {
        ...
        wp_enqueue_style( 'tether-drop', nkth()->plugin_url . 'assets/vendor/drop/dist/css/drop-theme-twipsy.min.css', array(), '1.7.1' );

        wp_enqueue_style( 'nk-theme-dashboard', nkth()->plugin_url . 'assets/css/theme-dashboard.min.css', array(), '1.7.1' );
        wp_style_add_data( 'nk-theme-dashboard', 'rtl', 'replace' );
        wp_style_add_data( 'nk-theme-dashboard', 'suffix', '.min' );

        wp_register_script( 'event-source-polyfill', nkth()->plugin_url . 'assets/vendor/eventsource/eventsource.min.js', array(), '1.7.1', true );
        wp_enqueue_script( 'tether', nkth()->plugin_url . 'assets/vendor/drop/dist/js/tether.min.js', array(), '1.7.1', true );
        wp_enqueue_script( 'tether-drop', nkth()->plugin_url . 'assets/vendor/drop/dist/js/drop.min.js', array(), '1.7.1', true );
        wp_enqueue_script( 'nk-theme-dashboard', nkth()->plugin_url . 'assets/js/theme-dashboard.min.js', array( 'jquery' ), '1.7.1', true );
