 ...
 */
function nkth_print_plugin_actions( $item, $installed_plugins ) {
    ...
    if ( ! isset( $installed_plugins[ $item['file_path'] ] ) && method_exists( TGM_Plugin_Activation::$instance, 'get_tgmpa_url' ) ) {
        printf(
    ...
    if ( isset( $installed_plugins[ $item['file_path'] ] ) && version_compare( $installed_plugins[ $item['file_path'] ]['Version'], $update_version, '<' ) && method_exists( TGM_Plugin_Activation::$instance, 'get_tgmpa_url' ) ) {
        printf(
            // translators: %1$s - url to plugin install.
            // translators: %2$s - plugin name.
        ...
        <div class="theme">
            <div class="theme-wrapper">
                <div class="theme-screenshot">
                    ...
                    if ( file_exists( nkth()->plugin_path . $thumbnail ) ) {
                        ?>
                         <img src="<?php echo esc_url( nkth()->plugin_url . $thumbnail ); ?>" alt=""/>
                        <?php
                    }
                    ?>
                ...
                <div class="theme-id-container">
                    ...
                    <div class="theme-actions">
                        <?php nkth_print_plugin_actions( $plugin, $installed_plugins ); ?>
                    </div>
                </div>
